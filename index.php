<?php
    $db = [
        ...
        [
            ...
            <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <span class='blue-text'>Centro Google per la sicurezza online</span>.</p>

            <p><span class='blue-text'>Scopri</span> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>",
        ],
        [
